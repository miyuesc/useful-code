...
const isArray: (obj: any) => boolean = (obj) => getRawType(obj) === 'array'
const isNullOrUndefined: (obj: any) => boolean = (obj) => !notNull(obj)
...
class EventEmitter {
  ...
  addListener(type: string, fn: Function, context?: ThisType<any>) {
    return this._addListener(type, fn, context)
  }

  _addListener(type: string, fn: Function, context?: ThisType<any>, once?: boolean) {
